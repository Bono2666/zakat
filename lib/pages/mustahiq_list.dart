...
class _mustahiqListState extends State<mustahiqList> {
  ...
  Future getMustahiq() async {
    var url = 'https://bonoworksdesign.com/zakat/get_mustahiq.php';
    var response = await http.get(Uri.parse(url));
    return json.decode(response.body);
  }

  Future delMustahiq(int index) async {
    var url = 'https://bonoworksdesign.com/zakat/del_mustahiq.php';
                                            ...
                                            onTap: () {
                                              Navigator.push(context,
                                                  MaterialPageRoute(builder: (context) =>
                                                      mustahiqAdd(list: list, index: index),));
                                            },
                                          ),
                                        ),
              ...
              children: [
                Positioned(
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.pushReplacementNamed(context, '/mustahiq_add');
                    },
                    child: Icon(
                      Icons.add,
                    ),
